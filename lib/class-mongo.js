...
function db_findSingle(coll, query, options, callback) {
    withDb(callback, function (db) {
        DriverCore_1.core.findSingle(db, coll, queryToMongo(query), options, callback);
    });
}
...
function db_updateSingle(coll, data, callback) {
    withDb(callback, function (db) {
        ...
        DriverCore_1.core.updateSingle(db, coll, query, data, callback);
    });
}
...
function db_patchMultipleBy(coll, query, patch, callback) {
    withDb(callback, function (db) {
        DriverCore_1.core.updateMultiple(db, coll, query, patch, callback);
    });
}
...
function db_patchMany(coll, arr, callback) {
    withDb(callback, function (db) {
        DriverCore_1.core.patchMany(db, coll, arr, callback);
    });
}
...
(function (EntityMethods) {
    ...
    function patchMultipleBy(coll, finder, patch) {
        return utils_1.cb_toPromise(Driver_1.db_patchMultipleBy, coll, finder, patch);
    }
    EntityMethods.patchMultipleBy = patchMultipleBy;
    function patch(coll, instance, patch) {
        var id = instance._id;
        if (id == null) {
