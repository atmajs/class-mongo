...
function setts_define(setts) {
    ...
    var name = (_a = setts.name, (_a !== null && _a !== void 0 ? _a : 'default'));
    var target = name === 'default' ? DefaultServer : Servers[name];
    if (target == null) {
        target = Servers[name] = __assign(__assign({}, DefaultServer), { name: (_b = setts) === null || _b === void 0 ? void 0 : _b.name });
    }
    target.ip = (_c = setts.ip, (_c !== null && _c !== void 0 ? _c : target.ip));
    target.port = (_d = setts.port, (_d !== null && _d !== void 0 ? _d : target.port));
    target.db = (_e = setts.db, (_e !== null && _e !== void 0 ? _e : target.db));
    target.params = (_f = setts.params, (_f !== null && _f !== void 0 ? _f : target.params));
    target.connection = (_g = setts.connection, (_g !== null && _g !== void 0 ? _g : target.connection));
}
...
function arr_pop(currentVal, mix, prop) {
    var _a;
    (_a = currentVal) === null || _a === void 0 ? void 0 : _a[mix > 0 ? 'pop' : 'shift']();
}
...
(function (Connections) {
    ...
    function getDb(server) {
        ...
        return (_b = _connections[server]) === null || _b === void 0 ? void 0 : _b.db;
    }
...
(function (ProjectionUtil) {
    function handleOpts(opts) {
        var _a;
        if ((_a = opts) === null || _a === void 0 ? void 0 : _a.projection) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, utils_1.cb_toPromise(Driver_1.db_aggregate, coll, $facet, options).then(function (resArr) {
                        ...
                        return {
                            ...
                            total: (_c = (_b = doc.total[0]) === null || _b === void 0 ? void 0 : _b.count, (_c !== null && _c !== void 0 ? _c : 0))
                        };
                    })];
            });
        });
...
(function (EntityMethods) {
    ...
    function patchBy(coll, finder, patch, opts) {
        var _a;
        var update = patchObject_1.obj_partialToUpdateQuery(patch, false, (_a = opts) === null || _a === void 0 ? void 0 : _a.deep);
    ...
    function patchMany(coll, arr, opts) {
        var _a;
        if ((_a = opts) === null || _a === void 0 ? void 0 : _a.deep) {
            for (var i = 0; i < arr.length; i++) {
...
function table(name, options) {
    return function (target) {
        ...
        meta.server = (_a = options) === null || _a === void 0 ? void 0 : _a.server;
        return target;
    };
}
exports.table = table;
...
exports.MongoProfiler = MongoProfiler_1.MongoProfiler;
