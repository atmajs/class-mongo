...
(function (core) {
    ...
    ;
    function updateSingle(db, coll, query, mod, callback /*<error, stats>*/) {
        db
            .collection(coll)
    ...
    ;
    function count(db, coll, query, callback /*<error, count>*/) {
        db
            .collection(coll)
...
(function (Connections) {
    ...
    var Connection = /** @class */ (function () {
        function Connection(url, params) {
            ...
            this.listeners = [];
            if (url == null) {
                this.url = Settings_1.getConnectionString();
            }
            if (params == null) {
                this.params = Settings_1.getParams();
            }
        }
    ...
    function connect(url, params, callback) {
        ...
        var _url = (url !== null && url !== void 0 ? url : Settings_1.getConnectionString());
        var _params = (params !== null && params !== void 0 ? params : Settings_1.getParams());
...
function core_profiler_toggle(enable, settings) {
    ...
    DriverCore_1.core.findSingle = function (db, coll, query, options, callback /*<error, item>*/) {
        ...
        _core_findSingle(db, coll, wrapQuery(query), options, analizator(coll, query));
    };
    ...
    DriverCore_1.core.count = function (db, coll, query, callback /*<error, count>*/) {
        _core_count.apply(null, arguments);
        _core_count(db, coll, wrapQuery(query), analizator(coll, query));
    };
}
...
;
function db_count(coll, query, callback) {
    withDb(callback, function (db) {
        DriverCore_1.core.count(db, coll, query, callback);
    });
}
...
function db_updateSingle(coll, data, callback) {
    withDb(callback, function (db) {
        ...
        DriverCore_1.core.updateSingle(db, coll, query, { $set: $set }, callback);
    });
}
...
;
function db_ensureObjectID(value) {
...
exports.db_ensureObjectID = db_ensureObjectID;
;
...
var MongoEntity = /** @class */ (function () {
    ...
    MongoEntity.count = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                coll = MongoMeta_1.MongoMeta.getCollection(this);
                return [2 /*return*/, utils_1.cb_toPromise(Driver_1.db_count, coll, query)];
            });
        });
    };
    ...
    MongoEntity.patch = function (instance, patch) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, EntityMethods.patch(instance, patch)];
            });
        });
    };
...
(function (EntityMethods) {
    ...
    function patch(x, patch) {
        ...
        var error = patchObject_1.obj_patchValidate(patch);
        if (error != null) {
            return Promise.reject(new Error(error));
        }
        patchObject_1.obj_patch(this, patch);
        return utils_1.cb_toPromise(Driver_1.db_patchSingle, coll, id, patch).then(function (_) { return x; });
    }
...
(function (MongoUtils) {
    function toObjectID(id) {
        return Driver_1.db_ensureObjectID(id);
    }
...
function index(mix, mix1, mix2) {
    return function (target, propertyKey, descriptor) {
        ...
        if (forProp) {
            var name = typeof mix === 'string' ? mix : null;
            var type = arguments.length === 3 ? mix1 : 1;
            var opts = arguments[arguments.length - 1];
            if (atma_utils_1.is_Object(opts) === false) {
                opts = null;
            }
            var idx = name ? indexes.find(function (x) { return x.name; }) : null;
            if (idx == null) {
                idx = {
                    name: name,
                    key: {}
